//go:generate mockgen -destination=rocket_mocks_test.go -package=rocket github.com/phanimullapudi/go-grpc-services/internal/rocket Store
...
type Store interface {
	...
	InsertRocket(rtk Rocket) (Rocket, error)
